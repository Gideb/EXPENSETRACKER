...
const BudgetSummary = ({ setOpenAddBudgetModal, refreshKey }) => {
  ...
  return (
    <div>
      <h5 className="text-2xl font-medium mb-4 pl-2 dark:text-gray-100">Budgets</h5>
      <div className="mb-8 space-y-6 card">
        {/* Header Section */}
              ...
              >
                <div className="relative p-5">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-11 h-11 rounded-xl bg-amber-50 dark:bg-amber-100 flex items-center justify-center text-amber-600 group-hover:scale-105 transition-transform duration-300">
                      {card.icon}
                    </div>
