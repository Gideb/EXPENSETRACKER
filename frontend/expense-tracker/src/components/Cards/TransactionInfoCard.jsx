        ...
        <div className="flex items-center gap-2">
          ...
          {!hideDeleteBtn && (
            <div className="relative" ref={menuRef}>
              <button
                className="
                  p-1 rounded-md text-gray-400 hover:text-gray-700
                  opacity-100
                  md:opacity-0
              ...
              {showMenu && (
                <div className="absolute right-5 top-1 w-30 bg-white border border-gray-200 rounded-lg shadow-lg z-50 overflow-hidden">
                  <button
                    onClick={handleEdit}
                    className="w-full flex items-center gap-4 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer"
                  >
                    <LuPencil size={16} />
                    Edit
                  </button>
