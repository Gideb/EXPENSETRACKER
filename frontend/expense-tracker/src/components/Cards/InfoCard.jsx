const InfoCard = ({ icon, label, value, color }) => {
  return (
    <div className="flex gap-6 bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-md hover:shadow-gray-300 dark:hover:shadow-slate-800 border border-gray-300 dark:border-gray-600 hover:shadow-2xl transition-all duration-500 ">
      <div
