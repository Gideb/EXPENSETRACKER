    ...
    <div>
          ...
          <>
            ...
            {healthStatus === 'yellow' && (
              <>
                ...
                <br />
                You've spent {spendingRatio.toFixed(1)}% of your income. Try to reduce spending.
              </>
            )}
            ...
            {healthStatus === 'red' && (
              <>
                🔴 Financial Health: Critical
                <br />
                You've spent {spendingRatio.toFixed(1)}% of your income. Expenses are too high.
              </>
            )}
          </>
        )}
      ...
      <div className="w-full bg-gray-200 h-2 rounded-full mt-2">
        <div
          ...
          style={{
            width: `${Math.min(totalIncome === 0 && totalExpense > 0 ? 100 : spendingRatio, 100)}%`,
          }}
        />
      </div>
    </div>
