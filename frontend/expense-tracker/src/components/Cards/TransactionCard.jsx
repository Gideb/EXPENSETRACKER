...
const TransactionCard = ({ title, icon, date, amount, type, hideDeleteBtn, onDelete }) => {
  ...
  return (
    <div className="group relative flex items-center gap-4 mt-2 p-3 rounded-lg hover:bg-gray-100/40 dark:bg-slate-800 dark:hover:bg-gray-500/80 border border-gray-200 dark:border-gray-600 mx-1 shadow-md hover:-translate-y-1.5 duration-500 ease-in-out transition-all hover:shadow-xl">
