...
const Modal = ({ title, onClose, isOpen, children }) => {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-[calc(100%-rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black/20 backdrop-opacity-30 ">
